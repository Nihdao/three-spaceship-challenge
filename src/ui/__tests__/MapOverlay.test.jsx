...
describe('worldToMapPct', () => {
  it('maps -2000 (world left edge) to 0%', () => {
    expect(worldToMapPct(-2000)).toBe(0)
  })
  ...
  it('maps 2000 (world right edge) to 100%', () => {
    expect(worldToMapPct(2000)).toBe(100)
  })

  it('maps 1000 to 75%', () => {
    expect(worldToMapPct(1000)).toBe(75)
  })

  it('maps -1000 to 25%', () => {
    expect(worldToMapPct(-1000)).toBe(25)
  })
})
